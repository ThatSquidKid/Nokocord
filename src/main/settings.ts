...
export const Settings = loadSettings<TSettings>(SETTINGS_FILE, "Nokotop settings");

export const VencordSettings = loadSettings<any>(VENCORD_SETTINGS_FILE, "Nokotop settings");
...
export const State = loadSettings<TState>(STATE_FILE, "Nokotop state");
